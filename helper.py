...
def scorecardDetails(args):
    url = "https://dev132-cricket-live-scores-v1.p.rapidapi.com/scorecards.php"
    querystring = {"seriesid":args.seriesId,"matchid":args.matchId}
    ...
    batsmen = data["fullScorecardAwards"]["mostRunsAwardPlayerResults"][0]["name"]
    bowler = data["fullScorecardAwards"]["mostWicketsAwardPlayerResults"][0]["name"]
    manOfTheMatch = data["fullScorecardAwards"]["manOfTheMatchName"]
    return batsmen, bowler, manOfTheMatch